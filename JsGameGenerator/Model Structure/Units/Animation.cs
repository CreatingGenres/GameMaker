...
namespace GameMaker.Model_Structure.Units
{
	public class Animation
	{
		...
		public bool MustPlayUntiFinished { get; set; }
			...
			foreach (var animation in this)
			{
				...
				if (!animation.IsEmpty)
					builder.AppendFormat("animations['{0}'] = new Animation({1}, {2}, {3}, {4}, {5}, {6});\n", 
						animation.Name, animation.RowIndex, framesPerRow, animation.StartColumn, animation.EndColumn, animation.Duration, animation.MustPlayUntiFinished.ToString().ToLowerInvariant());
				else
