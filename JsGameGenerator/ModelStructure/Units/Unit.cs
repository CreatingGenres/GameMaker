...
namespace GameMaker.ModelStructure.Units
{
	...
	public abstract class Unit : IExtensible, ICodeGenerator
	{
		...
		/// </summary>
		[EditorFieldAttribute(EditorFieldAttribute.EditorType.Text)]
		[XmlAttribute("id")]
		[JsonProperty("id")]
		...
		/// </summary>
		[EditorFieldAttribute(EditorFieldAttribute.EditorType.None)]
		[XmlArray("modules")]
		...
		/// </summary>
		[EditorFieldAttribute(EditorFieldAttribute.EditorType.Vector)]
		[XmlElement("rotation")]
		...
		/// <summary>
		/// Gets or sets a value indicating whether the unit is a prototype to a whole family of units or just a singleton.
		/// </summary>
		[EditorFieldAttribute(EditorFieldAttribute.EditorType.None)]
