...
var module = createModule('collider', (function() { var data = [];  return data; })());
	...
	return RectangleUnit;
			...
			var unit = createUnit(InanimatedSpriteUnit, false, 'Basic206', 'images/library/blue-monster.png', 29.8850574712644, 67.0299727520436, 40, 40, 1);
			unit.dx = 0; unit.dy = 0
unit.events = (function () { var events = [];
events['onSpawn'] = function(args) {basicEventHandler.call(this, this, (function() { var data = []; data['hp'] = ""; data['dX'] = ""; data['dY'] = ""; data['width'] = "150"; data['height'] = ""; data['stillPlaying'] = ""; data['points'] = "";  return data; })(), new Object({ target: '.Basic', module: '', args: new Object({})}));
};
return events; })();
raiseEvent(unit, 'onSpawn');
