...
unitModules['Dialog'] = function (action, unit) { raiseEvent(this, 'Dialog', arguments[0]); 
      
        var data = unit.moduleData["Dialog"];
...
unitModules['talk'] = function(params) { raiseEvent(this, 'talk', arguments[0]); 
        console.log(params.Dialog.visible);
        if (!params.Dialog || params.Dialog.visible == true)
          return;
        
        params.Dialog("next", params);
        setTimeout(function () {
          params.Dialog("hide", params);
        });
      };
...
var module = createModule('collider', (function() { var data = [];  return data; })());
	...
	return RectangleUnit;
			...
			var unit = createUnit(InanimatedSpriteUnit, false, 'Basic36', 'http://images2.wikia.nocookie.net/__cb20120922002943/fantendo/images/f/fc/MarioNSMBWii.png', 108.045977011494, 421.798365122616, 100, 100, 1);
			unit.dx = 5; unit.dy = 0
$.extend(unit, (function () {
		var moduleData = [];
		moduleData['move'] = (function() { var data = [];  return data; })();
moduleData['Dialog'] = (function() { var data = []; data['text1'] = "Pesho e gei"; data['text2'] = "..."; data['text3'] = "...";  return data; })();
...
basicEventHandler.call(this, this, (function() { var data = []; data['hp'] = ""; data['dX'] = ""; data['dY'] = ""; data['width'] = ""; data['height'] = ""; data['stillPlaying'] = ""; data['points'] = "";  return data; })(), new Object({ target: '#Basic36', module: 'move', args: new Object({dx: '-5', dy: '0', })}));
if (args['enemyName'] == eval("'Peach'") && true)
basicEventHandler.call(this, this, (function() { var data = []; data['hp'] = ""; data['dX'] = ""; data['dY'] = ""; data['width'] = ""; data['height'] = ""; data['stillPlaying'] = ""; data['points'] = "";  return data; })(), new Object({ target: '#Basic36', module: 'talk', args: new Object({})}));
};
return events; })();
raiseEvent(unit, 'onSpawn');


			var unit = createUnit(InanimatedSpriteUnit, false, 'Peach', 'http://www.mariowiki.com/images/thumb/7/75/Peach_FS.png/200px-Peach_FS.png', 466.666666666667, 433.242506811989, 50, 90, 1);
			unit.dx = 0; unit.dy = 0
raiseEvent(unit, 'onSpawn');
