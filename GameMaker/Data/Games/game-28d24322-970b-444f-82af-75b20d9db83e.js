...
var module = createModule('collider', (function() { var data = [];  return data; })());
	...
	return RectangleUnit;
			...
			var unit = createUnit(InanimatedSpriteUnit, false, 'Basic122', 'images/library/blue-monster.png', 181.609195402299, 135.694822888283, 40, 40, 1);
			unit.dx = 0; unit.dy = 0
$.extend(unit, (function () {
        ...
        var update = function () {
					...
					if (keyboard[None] && !previousKeyboard[None]) {
						var selected = selector('#Basic122');
