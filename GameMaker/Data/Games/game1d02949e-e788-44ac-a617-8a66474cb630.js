...
var module = createModule('collider', (function() { var data = [];  return data; })());
	...
	return RectangleUnit;
			...
			var unit = createUnit(InanimatedSpriteUnit, false, 'Basic203', 'images/library/blue-monster.png', 103.4483, 65.3951, 40, 40, 1);
			unit.dx = 0; unit.dy = 0
$.extend(unit, (function () {
        ...
        var update = function () {
					...
					if (keyboard[68] && !previousKeyboard[68]) {
						var selected = selector('#Basic203');
						for (var i in selected) {
							try {
                                selected[i].speechDisplayer(new Object({text: '...', updateCounter: '1000', }));
                            }
                            catch(error) { 
