...
basicEventHandler.call(this, this, (function() { var data = []; data['hp'] = ""; data['dX'] = "0"; data['dY'] = ""; data['width'] = ""; data['height'] = ""; data['stillPlaying'] = ""; data['points'] = "";  return data; })(), new Object({ target: '#Basic36', module: 'move', args: new Object({dx: '0', dy: '0', })}));
};
return events; })();
raiseEvent(unit, 'onSpawn');
