...
$(document).ready(function () {
    game = (function () {
		...
		background.src = 'http://www.wallmay.net/thumbnails/detail/20120903/nintendo%20super%20mario%201440x900%20wallpaper_www.wallmay.net_79.jpg';
...
var module = createModule('collider', (function() { var data = [];  return data; })());
	...
	return RectangleUnit;
			...
			var unit = createUnit(InanimatedSpriteUnit, false, 'Mario', 'http://images2.wikia.nocookie.net/__cb20120922002943/fantendo/images/f/fc/MarioNSMBWii.png', 386.206896551724, 436.512261580382, 100, 100, 1);
			unit.dx = -5; unit.dy = 0
...
basicEventHandler.call(this, this, (function() { var data = []; data['hp'] = ""; data['dX'] = ""; data['dY'] = ""; data['width'] = ""; data['height'] = ""; data['stillPlaying'] = ""; data['points'] = "";  return data; })(), new Object({ target: '#Mario', module: 'move', args: new Object({dx: '30', dy: '0', })}));
};
events['Dialog'] = function(args) {if (args['action'] == eval("'hide'") && true)
basicEventHandler.call(this, this, (function() { var data = []; data['hp'] = ""; data['dX'] = ""; data['dY'] = ""; data['width'] = ""; data['height'] = ""; data['stillPlaying'] = ""; data['points'] = "";  return data; })(), new Object({ target: '#Peach', module: 'Dialog', args: new Object({action: 'hide', })}));
};
return events; })();
raiseEvent(unit, 'onSpawn');


			var unit = createUnit(InanimatedSpriteUnit, false, 'Peach', 'http://www.mariowiki.com/images/thumb/7/75/Peach_FS.png/200px-Peach_FS.png', 21.8390804597701, 447.956403269755, 50, 90, 1);
			unit.dx = 0; unit.dy = 0
$.extend(unit, (function () {
		var moduleData = [];
