...
var module = createModule('collider', (function() { var data = [];  return data; })());
	...
	var RectangleUnit = (function () {
			...
			var unit = createUnit(InanimatedSpriteUnit, false, 'Basic3', 'images/library/blue-monster.png', 209.7403, 90, 40, 40, 1);
			unit.dx = 0; unit.dy = 0
raiseEvent(unit, 'onSpawn');


			var unit = createUnit(InanimatedSpriteUnit, false, 'Basic38', 'images/library/blue-monster.png', 453.8961, 256.5, 40, 40, 1);
			unit.dx = 0; unit.dy = 0
raiseEvent(unit, 'onSpawn');


			var unit = createUnit(InanimatedSpriteUnit, false, 'Basic160', 'images/library/blue-monster.png', 627.9221, 120, 40, 40, 1);
			unit.dx = 0; unit.dy = 0
raiseEvent(unit, 'onSpawn');


			var unit = createUnit(InanimatedSpriteUnit, false, 'Basic253', 'images/library/blue-monster.png', 74.67532, 111, 40, 40, 1);
			unit.dx = 0; unit.dy = 0
raiseEvent(unit, 'onSpawn');


			var unit = createUnit(InanimatedSpriteUnit, false, 'Basic141', 'images/library/blue-monster.png', 408.4416, 172.5, 40, 40, 1);
			unit.dx = 0; unit.dy = 0
raiseEvent(unit, 'onSpawn');
