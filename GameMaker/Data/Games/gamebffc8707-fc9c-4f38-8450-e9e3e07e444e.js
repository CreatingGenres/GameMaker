...
moduleData['Dialog'] = (function() { var data = []; data['text1'] = "Peach. Can i fuck you?"; data['text2'] = "I'll be gentle, i promise."; data['text3'] = "Hell, yeah!";  return data; })();
...
$.extend(unit, (function () {
		var moduleData = [];
		moduleData['Dialog'] = (function() { var data = []; data['text1'] = "Mario!!!"; data['text2'] = "Eww, gross!"; data['text3'] = "Ok, then, meet me at the next level.";  return data; })();
moduleData['talk'] = (function() { var data = [];  return data; })();
