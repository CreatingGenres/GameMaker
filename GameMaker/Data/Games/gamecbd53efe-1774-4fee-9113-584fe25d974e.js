...
var module = createModule('collider', (function() { var data = [];  return data; })());
	...
	return RectangleUnit;
			...
			var unit = createUnit(InanimatedSpriteUnit, false, 'Basic149', 'images/library/blue-monster.png', 191.954, 125.8856, 40, 40, 1);
			unit.dx = 0; unit.dy = 0
...
events['onSpawn'] = function(args) {basicEventHandler.call(this, this, (function() { var data = []; data['hp'] = ""; data['dX'] = ""; data['dY'] = ""; data['width'] = ""; data['height'] = ""; data['stillPlaying'] = ""; data['points'] = "";  return data; })(), new Object({ target: '#Basic149', module: 'move', args: new Object({dx: '4', dy: '0', })}));
};
return events; })();
raiseEvent(unit, 'onSpawn');
