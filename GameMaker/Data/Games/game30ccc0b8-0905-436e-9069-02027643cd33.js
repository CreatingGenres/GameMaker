...
var module = createModule('collider', (function() { var data = [];  return data; })());
	...
	return RectangleUnit;
			...
			var unit = createUnit(InanimatedSpriteUnit, false, 'Basic105', 'http://forums.academy.telerik.com/?qa=image&qa_blobid=17582266960833535034&qa_size=200', 139.0805, 369.4823, 100, 100, 1);
			unit.dx = 0; unit.dy = 0
$.extend(unit, (function () {
        ...
        var update = function () {
					...
					if (keyboard[65]) {
						var selected = selector('#Basic105');
