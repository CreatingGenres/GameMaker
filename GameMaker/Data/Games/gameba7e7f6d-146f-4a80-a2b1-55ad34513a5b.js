...
events['onSpawn'] = function(args) {basicEventHandler.call(this, this, (function() { var data = []; data['hp'] = ""; data['dX'] = "+5"; data['dY'] = ""; data['width'] = ""; data['height'] = ""; data['stillPlaying'] = ""; data['points'] = "";  return data; })(), new Object({ target: '#Basic149', module: 'charge', args: new Object({endX: '500', endY: '100', shouldReturn: 'true', })}));
};
return events; })();
raiseEvent(unit, 'onSpawn');
