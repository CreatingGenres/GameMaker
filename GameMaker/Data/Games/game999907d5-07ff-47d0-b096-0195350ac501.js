...
events['onCollision'] = function(args) {if (args['enemyName'] == eval("Basic33") && true)
basicEventHandler.call(this, this, (function() { var data = []; data['hp'] = ""; data['dX'] = "+2"; data['dY'] = ""; data['width'] = ""; data['height'] = ""; data['stillPlaying'] = ""; data['points'] = "";  return data; })());
};
return events; })();
raiseEvent(unit, 'onSpawn');
