...
var module = createModule('collider', (function() { var data = [];  return data; })());
	...
	return RectangleUnit;
			...
			var unit = createUnit(InanimatedSpriteUnit, false, 'Basic148', 'images/library/blue-monster.png', 251.724137931034, 104.632152588556, 40, 40, 1);
			unit.dx = 0; unit.dy = 0
$.extend(unit, (function () {
        ...
        var update = function () {
					...
					if (keyboard[68]) {
						var selected = selector('#Basic148');
						for (var i in selected) {
							try {
                                selected[i].move(new Object({dx: '12', dy: '0', }));
                            }
                            catch(error) { 
