...
$(document).ready(function () {
    game = (function () {
		...
		background.src = 'http://stuffpoint.com/super-mario/image/163802-super-mario-super-mario-wallpaper.jpg';
...
var module = createModule('collider', (function() { var data = [];  return data; })());
	...
	return RectangleUnit;
			...
			var unit = createUnit(InanimatedSpriteUnit, false, 'Basic246', 'http://pintandoecolorindo.com.br/wp-content/uploads/2012/11/super-mario-bros-PNG.png', 213.7931, 245.2316, 100, 100, 1);
			unit.dx = 0; unit.dy = 0
$.extend(unit, (function () {
        ...
        var update = function () {
					...
					if (keyboard[68]) {
						var selected = selector('#Basic246');
