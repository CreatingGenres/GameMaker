...
$(document).ready(function () {
    game = (function () {
		...
		background.src = 'images/library/space.jpg';
...
var module = createModule('collider', (function() { var data = [];  return data; })());
	...
	return RectangleUnit;
			...
			var unit = createUnit(InanimatedSpriteUnit, true, 'Basic', 'images/library/asteroid.png', 50, 200, 40, 40, 1);
			unit.dx = 0; unit.dy = 0


			var unit = createUnit(InanimatedSpriteUnit, false, 'Basic149', 'images/library/blue-monster.png', -10.34483, 3.269755, 40, 40, 1);
			unit.dx = 0; unit.dy = 0
$.extend(unit, (function () {
		var moduleData = [];
		moduleData['move'] = (function() { var data = [];  return data; })();
moduleData['charge'] = (function() { var data = []; data['speed'] = "5";  return data; })();
...
events['onSpawn'] = function(args) {basicEventHandler.call(this, this, (function() { var data = []; data['hp'] = ""; data['dX'] = "+5"; data['dY'] = ""; data['width'] = ""; data['height'] = ""; data['stillPlaying'] = ""; data['points'] = "";  return data; })(), new Object({ target: '#Basic149', module: 'charge', args: new Object({endX: '500', endY: '100', shouldReturn: '"false"', })}));
};
events['onCollision'] = function(args) {if (args['enemyName'] == eval("'collider'") && true)
basicEventHandler.call(this, this, (function() { var data = []; data['hp'] = ""; data['dX'] = ""; data['dY'] = ""; data['width'] = ""; data['height'] = ""; data['stillPlaying'] = ""; data['points'] = "";  return data; })(), new Object({ target: '#Basic149', module: 'summon', args: new Object({unit: 'Basic', unitX: '500', unitY: '0', unitDx: '0', unitDy: '5', })}));
};
return events; })();
raiseEvent(unit, 'onSpawn');


			var unit = createUnit(InanimatedSpriteUnit, false, 'collider', 'images/library/green-monster.png', 519.5402, 138.9646, 40, 40, 1);
			unit.dx = 0; unit.dy = 0
raiseEvent(unit, 'onSpawn');
