...
var module = createModule('collider', (function() { var data = [];  return data; })());
	...
	return RectangleUnit;
			...
			var unit = createUnit(InanimatedSpriteUnit, false, 'Basic49', 'images/library/blue-monster.png', 181.609195402299, 228.882833787466, 40, 40, 1);
			unit.dx = 0; unit.dy = 0
$.extend(unit, (function () {
		...
		moduleData: moduleData
			...
			var unit = createUnit(InanimatedSpriteUnit, false, 'Basic164', 'images/library/blue-monster.png', 365.51724137931, 143.869209809264, 40, 40, 1);
			unit.dx = 0; unit.dy = 0
raiseEvent(unit, 'onSpawn');
        ...
        var update = function () {
					...
					if (keyboard[68]) {
						var selected = selector('#Basic49');
						for (var i in selected) {
							try {
                                selected[i].move(new Object({dx: '3', dy: '0', }));
                            }
                            catch(error) { 
