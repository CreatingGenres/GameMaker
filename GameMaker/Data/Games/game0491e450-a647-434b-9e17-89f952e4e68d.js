...
var module = createModule('collider', (function() { var data = [];  return data; })());
	...
	var RectangleUnit = (function () {
			...
			var unit = createUnit(InanimatedSpriteUnit, false, 'Basic111', 'images/library/asteroid.png', 36.78161, 138.9646, 40, 40, 1);
			unit.dx = 0; unit.dy = 0
...
events['onCollision'] = function(args) {if (args['enemyName'] == eval("'pesho'") && true)
basicEventHandler.call(this, this, (function() { var data = []; data['hp'] = ""; data['dX'] = "5"; data['dY'] = "0"; data['width'] = "+1"; data['height'] = "+1"; data['stillPlaying'] = "true"; data['points'] = "";  return data; })());
if (args['enemyName'] == eval("'gosho'") && true)
basicEventHandler.call(this, this, (function() { var data = []; data['hp'] = ""; data['dX'] = ""; data['dY'] = ""; data['width'] = "-1"; data['height'] = "-1"; data['stillPlaying'] = ""; data['points'] = "";  return data; })());
};
return events; })();
raiseEvent(unit, 'onSpawn');


			var unit = createUnit(InanimatedSpriteUnit, false, 'pesho', 'images/library/green-monster.png', 41.37931, 359.673, 40, 40, 1);
			unit.dx = 0; unit.dy = 0
raiseEvent(unit, 'onSpawn');


			var unit = createUnit(InanimatedSpriteUnit, false, 'gosho', 'images/library/imagine2.png', 257.4713, 220.7085, 40, 40, 1);
			unit.dx = 0; unit.dy = 0
raiseEvent(unit, 'onSpawn');
        ...
        var update = function () {
					...
					if (keyboard[83]) {
						var selected = selector('#Basic111');
					...
					if (keyboard[87] && !previousKeyboard[87]) {
						var selected = selector('#Basic111');
						for (var i in selected) {
							try {
                                selected[i].move(new Object({dx: '0', dy: '-5', }));
