...
var module = createModule('collider', (function() { var data = [];  return data; })());
	...
	return RectangleUnit;
			...
			var unit = createUnit(InanimatedSpriteUnit, false, 'Mario', 'http://images2.wikia.nocookie.net/__cb20120922002943/fantendo/images/f/fc/MarioNSMBWii.png', 450.574712643678, 436.512261580382, 100, 100, 1);
			unit.dx = -5; unit.dy = 0
...
basicEventHandler.call(this, this, (function() { var data = []; data['hp'] = ""; data['dX'] = ""; data['dY'] = ""; data['width'] = ""; data['height'] = ""; data['stillPlaying'] = ""; data['points'] = "";  return data; })(), new Object({ target: '#Mario', module: 'move', args: new Object({dx: '8', dy: '0', })}));
};
...
raiseEvent(unit, 'onSpawn');
			...
			var unit = createUnit(InanimatedSpriteUnit, false, 'Peach', 'http://www.mariowiki.com/images/thumb/7/75/Peach_FS.png/200px-Peach_FS.png', 70.1149425287356, 447.956403269755, 50, 90, 1);
			unit.dx = 0; unit.dy = 0
$.extend(unit, (function () {
		var moduleData = [];
