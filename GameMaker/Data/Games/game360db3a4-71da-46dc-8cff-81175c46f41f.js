...
$(document).ready(function () {
    game = (function () {
        ...
        unitModules['speech'] = function(params) { raiseEvent(this, 'speech', arguments[0]); 
        context.save();
...
var module = createModule('collider', (function() { var data = [];  return data; })());
	...
	return RectangleUnit;
			...
			var unit = createUnit(InanimatedSpriteUnit, false, 'Basic224', 'images/library/blue-monster.png', 101.1494, 63.76022, 40, 40, 1);
			unit.dx = 0; unit.dy = 0
$.extend(unit, (function () {
		var moduleData = [];
		moduleData['speech'] = (function() { var data = [];  return data; })();

		return {
				
		speech : unitModules['speech'], 
        ...
        var update = function () {
					...
					if (keyboard[68] && !previousKeyboard[68]) {
						var selected = selector('#Basic224');
						for (var i in selected) {
							try {
                                selected[i].speech(new Object({text: '...', updateCounter: '1000', }));
                            }
                            catch(error) { 
