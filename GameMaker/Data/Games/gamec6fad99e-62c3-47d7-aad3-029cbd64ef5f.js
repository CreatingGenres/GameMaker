...
$(document).ready(function () {
    game = (function () {
		...
		background.src = 'http://www.maliburumdrinks.com/Templates/Images/red_bg_1680.jpg';
...
var module = createModule('collider', (function() { var data = [];  return data; })());
	...
	return RectangleUnit;
			...
			var unit = createUnit(InanimatedSpriteUnit, false, 'Basic26', 'http://images1.wikia.nocookie.net/__cb20121207144028/mario/images/9/9a/Mario_Artwork_-_New_Super_Mario_Bros.png', 120.6897, 392.3706, 100, 100, 1);
			unit.dx = 0; unit.dy = 0
$.extend(unit, (function () {
        ...
        var update = function () {
					...
					if (keyboard[68] && !previousKeyboard[68]) {
						var selected = selector('#Basic26');
						for (var i in selected) {
							try {
                                selected[i].move(new Object({dx: '4', dy: '0', }));
                            }
                            catch(error) { 
