...
basicEventHandler.call(this, this, (function() { var data = []; data['hp'] = ""; data['dX'] = "0"; data['dY'] = ""; data['width'] = ""; data['height'] = ""; data['stillPlaying'] = ""; data['points'] = "";  return data; })(), new Object({ target: '.Basic', module: '', args: new Object({})}));
};
return events; })();
raiseEvent(unit, 'onSpawn');
