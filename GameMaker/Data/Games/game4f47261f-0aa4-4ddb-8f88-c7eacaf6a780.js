...
unitModules['unit-generator'] = function () { raiseEvent(this, 'unit-generator', arguments[0]); 
				var counter = 0;
...
var module = createModule('collider', (function() { var data = [];  return data; })());
	...
	return RectangleUnit;
			...
			var unit = createUnit(InanimatedSpriteUnit, false, 'Basic99', 'images/library/blue-monster.png', 148.2759, 238.6921, 40, 40, 1);
			unit.dx = 0; unit.dy = 0
$.extend(unit, (function () {
		var moduleData = [];
		moduleData['move'] = (function() { var data = [];  return data; })();
moduleData['unit-generator'] = (function() { var data = [];  return data; })();

		return {
				
		move : unitModules['move'], 
	
		unit-generator : unitModules['unit-generator'], 
		moduleData: moduleData
		};
	})());unit.events = (function () { var events = [];
events['onCollision'] = function(args) {if (args['enemyName'] == eval("eetqe") && true)
basicEventHandler.call(this, this, (function() { var data = []; data['hp'] = ""; data['dX'] = ""; data['dY'] = ""; data['width'] = ""; data['height'] = ""; data['stillPlaying'] = ""; data['points'] = "";  return data; })(), new Object({ target: '.Basic', module: 'unit-generator', args: new Object({unit: '0', unitX: '0', unitY: '0', unitDx: '0', unitDy: '0', })}));
if (args['enemyName'] == eval("asfasdf") && true)
basicEventHandler.call(this, this, (function() { var data = []; data['hp'] = ""; data['dX'] = ""; data['dY'] = ""; data['width'] = ""; data['height'] = ""; data['stillPlaying'] = ""; data['points'] = "";  return data; })(), new Object({ target: '.Basic', module: 'move', args: new Object({dx: '0', dy: '0', })}));
};
return events; })();
raiseEvent(unit, 'onSpawn');
