...
var module = createModule('collider', (function() { var data = [];  return data; })());
		...
		var module = createModule('timer', (function() { var data = []; data['interval'] = "1000"; data['target'] = "sdfg"; data['action'] = "sdfg"; data['args'] = new Object({sdfg});  return data; })());
		$.extend(module, (function() {
				return {
						last: new Date(),
						update: function() {
	...
	var RectangleUnit = (function () {
			...
			var unit = createUnit(InanimatedSpriteUnit, false, 'Basic125', 'images/library/blue-monster.png', 157.7922, 159, 40, 40, 1);
			unit.dx = 0; unit.dy = 0
raiseEvent(unit, 'onSpawn');


			var unit = createUnit(InanimatedSpriteUnit, false, 'Basic61', 'images/library/blue-monster.png', 447.4026, 214.5, 40, 40, 1);
			unit.dx = 0; unit.dy = 0
unit.events = (function () { var events = [];
events['onCollision'] = function(args) {if (args['enemyName'] == eval("dsfgscxcb") && true)
basicEventHandler.call(this, this, (function() { var data = []; data['hp'] = "cxbxcvbgdsgf"; data['dX'] = ""; data['dY'] = ""; data['width'] = ""; data['height'] = ""; data['stillPlaying'] = ""; data['points'] = "";  return data; })());
};
return events; })();
raiseEvent(unit, 'onSpawn');


			var unit = createUnit(InanimatedSpriteUnit, true, 'Basic61', 'images/library/blue-monster.png', 447.4026, 214.5, 40, 40, 1);
			unit.dx = 0; unit.dy = 0
unit.events = (function () { var events = [];
events['onCollision'] = function(args) {if (args['enemyName'] == eval("dsfgscxcb") && true)
basicEventHandler.call(this, this, (function() { var data = []; data['hp'] = "cxbxcvbgdsgf"; data['dX'] = ""; data['dY'] = ""; data['width'] = ""; data['height'] = ""; data['stillPlaying'] = ""; data['points'] = "";  return data; })());
...
return events; })();
			...
			var unit = createUnit(InanimatedSpriteUnit, false, 'Basic47', 'images/library/games.png', 351.2987, 177, 40, 40, 1);
			unit.dx = 0; unit.dy = 0
raiseEvent(unit, 'onSpawn');
