...
var module = createModule('collider', (function() { var data = [];  return data; })());
	...
	return RectangleUnit;
			...
			var unit = createUnit(InanimatedSpriteUnit, false, 'Basic36', 'http://images2.wikia.nocookie.net/__cb20120922002943/fantendo/images/f/fc/MarioNSMBWii.png', 111.494252873563, 413.623978201635, 100, 100, 1);
			unit.dx = 0; unit.dy = 0
...
events['onSpawn'] = function(args) {basicEventHandler.call(this, this, (function() { var data = []; data['hp'] = ""; data['dX'] = ""; data['dY'] = ""; data['width'] = ""; data['height'] = ""; data['stillPlaying'] = ""; data['points'] = "";  return data; })(), new Object({ target: '#Basic36', module: 'move', args: new Object({dx: '5', dy: '0', })}));
};
return events; })();
raiseEvent(unit, 'onSpawn');
