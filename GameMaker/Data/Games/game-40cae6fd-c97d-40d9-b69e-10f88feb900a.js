...
var module = createModule('collider', (function() { var data = [];  return data; })());
	...
	return RectangleUnit;
			...
			var unit = createUnit(InanimatedSpriteUnit, false, 'Basic122', 'images/library/blue-monster.png', 337.931034482759, 119.346049046322, 40, 40, 1);
			unit.dx = 0; unit.dy = 0
        ...
        var update = function () {
					...
					if (keyboard[68] && !previousKeyboard[68]) {
						...
						for (var i in selected) {
							try {
                                selected[i].move(new Object({dx: '0', dy: '0', }));
                            }
                            catch(error) { 
