...
var module = createModule('collider', (function() { var data = [];  return data; })());
	...
	return RectangleUnit;
			...
			var unit = createUnit(InanimatedSpriteUnit, false, 'Basic129', 'images/library/blue-monster.png', 263.218390804598, 188.010899182561, 40+130, 40, 1);
			unit.dx = updateCounter/1000; unit.dy = 0
raiseEvent(unit, 'onSpawn');


			var unit = createUnit(InanimatedSpriteUnit, false, 'Basic44', 'images/library/blue-monster.png', 227.586206896552, 145.50408719346, 40, 40, 1);
			unit.dx = 2+updateCounter/100; unit.dy = 0
raiseEvent(unit, 'onSpawn');
